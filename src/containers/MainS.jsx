  ...
  return (
    <div className='container  mx-auto bg-[#141414] mt-28'>
      ...
      <div >
        ...
        <p className='font-normal text-lg text-[#999999] mb-12 mt-7'>Were here to help you with any problems you may be having with our product.</p>
    ...
    <label form='horns' className='text-[#FFF] mr-[300px]'>I agree </label>
